...
export HANDLE, HMODULE, EnumFontProc, HWND, HDC, WORD, 
DWORD, LPDWORD, WPARAM, LPARAM, LPCSTR, LPCWSTR, LPSTR, 
BOOL, LF_FACESIZE, LF_FULLFACESIZE, PROC_SIZE, MAX_PATH, PROCESS_QUERY_INFORMATION, 
PROCESS_VM_READ, FontPitchAndFamily, FontCharSet, FontQuality, FontType, FontWeight, 
LOGFONTA, ENUMLOGFONTA, NEWTEXTMETRICA, SECURITY_ATTRIBUTES
